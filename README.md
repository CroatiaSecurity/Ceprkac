...
[![version](https://img.shields.io/badge/version-0.7.6-blue?style=flat-square)](CHANGELOG.md)
...
**Download:** [Ceprkac 0.7.6 Setup](https://github.com/CroatiaSecurity/Ceprkac/releases/latest) · **History:** [CHANGELOG](CHANGELOG.md)
...
Output: `releases\0.7.6\Ceprkac-0.7.6-Setup.exe`
