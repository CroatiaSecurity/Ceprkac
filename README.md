...
[![version](https://img.shields.io/badge/version-0.8.1-blue?style=flat-square)](CHANGELOG.md)
...
**Download:** [Ceprkac 0.8.1 Setup](https://github.com/CroatiaSecurity/Ceprkac/releases/latest) · **History:** [CHANGELOG](CHANGELOG.md)
...
Output: `releases\0.8.1\Ceprkac-0.8.1-Setup.exe`
