...
[![version](https://img.shields.io/badge/version-0.6.9-blue?style=flat-square)](CHANGELOG.md)
...
**Download:** [Ceprkac 0.6.9 Setup](https://github.com/CroatiaSecurity/Ceprkac/releases/latest) · **History:** [CHANGELOG](CHANGELOG.md)
...
Output: `releases\0.6.9\Ceprkac-0.6.9-Setup.exe`
